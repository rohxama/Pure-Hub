...
import abtSecImg from '../../assets/abt-img.avif'
...
import maskExpImg from '../../assets/mask-exp.avif'
...
import blogImg1 from '../../assets/blog-img1.avif'
    ...
    <>
      ...
      <section className="pure-hub-contact-wrap">
        ...
        <footer className="pure-hub-home-footer">
          <img src={logoImg} alt="Pure Hub" className="pure-hub-footer-logo" />
